...
@section('breadcrumb-item-active', 'Éditer un tag')
...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="{{ route('backoffice.product-tags.update', $product_tag) }}"
              method="POST"
            ...
            <div id="form-container" class="card">
                <div class="card-header">
                    <h5 class="mb-0">Éditer le tag</h5>
                </div>

                <div class="card-body">
                    {{-- Le partiel attend une variable $tag --}}
                    @include('backoffice.product_tags._form', ['tag' => $product_tag])
                </div>
