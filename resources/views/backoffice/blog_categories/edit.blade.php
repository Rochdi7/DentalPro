...
<div class="row">
  <div class="col-md-12">
    ...
    <form action="{{ route('backoffice.blog_categories.update', $category) }}" method="POST" class="needs-validation" novalidate>
      @csrf
      @method('PUT')
      ...
      <div id="blog-category-form-card" class="card animate__animated animate__fadeIn">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <div class="invalid-feedback">
              @error('parent_id') {{ $message }} @else Veuillez sélectionner une catégorie parente valide. @enderror
            </div>
          </div>
...
<script>
  ...
  // Animation fadeOut lors de l’annulation
