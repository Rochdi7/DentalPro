...
@section('breadcrumb-item-active', 'Ajouter un tag')
...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="{{ route('backoffice.blog_tags.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf

            <div id="blog-tag-form-card" class="card animate__animated animate__fadeIn">
                <div class="card-header">
                    <h5 class="mb-0">Ajouter un tag</h5>
                </div>
