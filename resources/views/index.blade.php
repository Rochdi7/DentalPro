                                ...
                                <div class="ps-banner__block">
                                    ...
                                    <div class="ps-banner__thumnail">
                                        <img class="ps-banner__round" src="{{ asset('assets/img/round2.png') }}"
                                            alt="fond rond" />
                                        <img class="ps-banner__image" src="{{ asset('assets/img/promotion/slide1.png') }}"
                                            alt="kit blanchiment" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="ps-banner__block">
                                    ...
                                    <div class="ps-banner__thumnail">
                                        <img class="ps-banner__round" src="{{ asset('assets/img/round5.png') }}"
                                            alt="fond rond" />
                                        <img class="ps-banner__image" src="{{ asset('assets/img/promotion/slide3.png') }}"
                                            alt="masque médical" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ps-promo ps-not-padding">
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <div class="ps-promo__item">
                                        <img class="ps-promo__banner"
                                            src="{{ asset('assets/img/promotion/bg-banner1.jpg') }}"
                                            alt="Nouvelle promo" />
                                        <div class="ps-promo__content">
                                            <span class="ps-promo__badge">Nouveau</span>
                                            <h4 class="mb-20 ps-promo__name">Vaporisateur <br />Chargeur <br />X200 5KW</h4>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="ps-promo__item">
                                        <img class="ps-promo__banner"
                                            src="{{ asset('assets/img/promotion/bg-banner2.jpg') }}"
                                            alt="Thermomètre numérique" />
                                        <div class="ps-promo__content">
                                            <h4 class="ps-promo__name">Thermomètre <br />Numérique <br />X30-Pro</h4>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="ps-promo__item">
                                        <img class="ps-promo__banner"
                                            src="{{ asset('assets/img/promotion/bg-banner3.jpg') }}"
                                            alt="Brosse hygiénique" />
                                        <div class="ps-promo__content">
                                            <h4 class="text-white ps-promo__name">SuperBrosse <br />X200 Hygiénique</h4>
                                            <div class="ps-promo__meta">
                                                <p class="ps-promo__price">1 190,00 MAD</p>
                            ...
                            <div class="ps-category--block">
                                <div class="ps-category__thumbnail">
                                    <a class="ps-category__image" href="category-grid.html">
                                        <img src="{{ asset('assets/img/promotion/facemask-cat.png') }}" alt>
                                    </a>
                                    <div class="ps-category__content">
                                        <a class="ps-category__name" href="category-grid.html">Masques faciaux</a>
                                ...
                                <div class="ps-category__thumbnail">
                                    ...
                                    <div class="ps-category__content">
                                        <a class="ps-category__name" href="category-grid.html">Uniformes</a>
                                        <a class="ps-category__more" href="category-grid.html">Voir plus</a>
                                    </div>
                                </div>
                                ...
                                <div class="tab-content" id="bestsellerTabContent">
                                    @foreach ($categories->take(3) as $category)
                                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                            ...
                                            <div class="owl-carousel" data-owl-auto="false" data-owl-loop="true"
                                                data-owl-speed="13000" data-owl-gap="0" data-owl-nav="true"
                                                data-owl-dots="true" data-owl-item="5" data-owl-item-xs="2"
                                                data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="5"
                        ...
                        <div class="ps-promo">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="ps-promo__item">
                                        <img class="ps-promo__banner"
                                            src="{{ asset('assets/img/promotion/bg-banner4.jpg') }}" alt="alt" />
                                        <div class="ps-promo__content">
                                            <span class="ps-promo__badge">Nouveau</span>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="ps-promo__item">
                                        <img class="ps-promo__banner"
                                            src="{{ asset('assets/img/promotion/bg-banner5.jpg') }}" alt="alt" />
                                        <div class="ps-promo__content">
                                ...
                                <div class="row m-0">
                                    <div class="col-6 col-md-4 col-lg-2">
                                        <a class="ps-image--transition" href="https://www.instagram.com/p/CDf7FC7pwae/">
                                            <img src="{{ asset('assets/img/instagram/instagram1.jpg') }}" alt>
